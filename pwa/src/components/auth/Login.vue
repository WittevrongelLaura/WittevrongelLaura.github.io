    ...
    <div>
      <form @submit.prevent="submitForm">
        ...
        <div class="mt-3">
          ...
          <p class="mt-1 text-sm font-normal text-green900 opacity-70 ">
            <RouterLink
            class="rounded-md outline-none  ring-neutral-300 hover:underline hover:opacity-100 focus-visible:ring"
        ...
        <button
        class="mt-6 flex w-full items-center justify-center rounded-md bg-green700 py-2 px-3 text-white outline-none ring-neutral-300 hover:bg-green900 focus-visible:ring-green900 focus-visible:ring-1"
          :disabled="loading"
          data-cy="login"
        >
        ...
        <p class="mt-3 text-center text-green900 opacity-60 text-sm ">
          <RouterLink
            to="/auth/register"
            class="rounded-md outline-none  ring-neutral-300 hover:underline hover:opacity-100 focus-visible:ring"
          >
